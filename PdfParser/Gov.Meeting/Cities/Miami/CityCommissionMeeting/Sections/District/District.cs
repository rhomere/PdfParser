...
namespace Gov.Meeting.Cities.Miami.CityCommissionMeeting.Sections.District
{
    public class District : SectionBase
    {
        ...
        //Todo, Using DiscussionItem in District.cs, Double check this
        public List<DiscussionItem> DiscussionItems { get; set; } = new List<DiscussionItem>();

        public District(PdfPageCollection pages, int index, out int outIndex)
        {
            _index = index;
            _pages = pages;
