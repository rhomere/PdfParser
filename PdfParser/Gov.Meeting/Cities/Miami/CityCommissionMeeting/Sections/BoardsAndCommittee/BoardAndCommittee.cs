...
namespace Gov.Meeting.Cities.Miami.CityCommissionMeeting.Sections.BoardsAndCommittee
{
    public class BoardAndCommittee : SectionBase
    {
        ...
        public List<BoardAndCommitteeItem> BoardsAndCommitteeItems { get; set; } = new List<BoardAndCommitteeItem>();

        public BoardAndCommittee(PdfPageCollection pages, int index, out int outIndex)
        {
            _index = index;
            _pages = pages;
