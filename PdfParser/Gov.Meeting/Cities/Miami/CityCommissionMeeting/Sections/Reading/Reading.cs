...
namespace Gov.Meeting.Cities.Miami.CityCommissionMeeting.Sections.Reading
{
    public class Reading : SectionBase
    {
        ...
        public List<ReadingItem> ReadingOrdinances { get; set; } = new List<ReadingItem>();
        ...
        private void LoadOrdinances(bool singlePage = false)
        {
            ...
            while (_.Contains(startOfResolution))
            {
                ...
                // Add Item
                ReadingOrdinances.Add(new ReadingItem
                {
