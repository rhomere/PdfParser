...
namespace Gov.Meeting.Cities.Miami.CityCommissionMeeting.Sections.SecondReading
{
    public class SecondReading : SectionBase
    {
        #region Private Properties
        private string _resolution = "ORDINANCE";
        private string _resolutionHeaderSpace = "ORDINANCE                                                        Second Reading \r\n";
        ...
        private string _start = "SR - SECOND READING ORDINANCES";
        private string _end = "END OF SECOND READING ORDINANCES";
        #endregion

        public List<SecondReadingItem> SecondReadingOrdinances { get; set; } = new List<SecondReadingItem>();
